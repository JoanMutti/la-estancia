        ...
        <div className='sc-product'>
            <div className='sc-info-product-container'>
                ...
                <div className='sc-product-name-price'>
                    ...
                    <p className='sc-product-price'>$ {(product.price * product.cant).toFixed(2)}</p>
                </div>
            </div>
            <div className='sc-product-controls'>
                <FiEdit fontSize={20} color='rgb(21, 20, 21)' onClick={() => setOpenEdit(!openEdit)}/>
                <RiDeleteBin6Line fontSize={20} color='rgb(21, 20, 21)' onClick={() => removeProduct(product)} />
            </div>
            {openEdit && (
                <EditItemCount styleClass={{container: 'sc-product-edit', text: 'sc-product-edit-kg'}} onClickAdd={addMore} onClickRemove={removeMore} product={product} />
            )}
        </div>
    )
}
            ...
            {products.length > 0 ? (
                <>
                    ...
                    <div className='sc-subtotal-container'>
                        ...
                        <p className='sc-subtotal-price'>{`$ ${getSubtotal().toFixed(2)}`}</p>
                    </div>
